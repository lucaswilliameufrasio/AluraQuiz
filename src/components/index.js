...
export { default as InfiniteRotation } from '../components/InfiniteRotation'
export { default as AlternativesForm } from '../components/AlternativesForm'

export { default as QuizPage } from './pages/Quiz'
